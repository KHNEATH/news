...
if (empty($_SESSION['userid'])) { // Check if userid is empty or not set
  ...
  // Check if session variable for this news item is not set (indicating first visit for this news item in this session)
  if (!isset($_SESSION['visited_' . $newsId])) {
    try {
      ...
      // Set session variable to indicate visit for this news item
      $_SESSION['visited_' . $newsId] = true;
    ...
    <div class="row">
      <?php foreach ($result as $row) : ?>
        <div class="col-lg-3 col-sm-12 mb-4">
          <!-- trov link vea jol knea mouy dom dermbey hover ban all -->
